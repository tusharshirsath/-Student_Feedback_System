...
import Dao.Institute_evaluation;
import Dao.Institute_evaluationimpl;
...
public class Student_Info extends javax.swing.JFrame {
    ...
    public Student_Info() {
        initComponents();
        setIconImage(new ImageIcon("D:\\StudentFeedbackSystem\\Code+Database+Jar Files\\Student_Feedback_System\\logo.jpeg").getImage());
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(803, 923));
        setResizable(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String s3= courseobj; 
        String s4= practical;
        String s5= assessment;
        String s6=planning;
        String s7=impl;
        String s8=seminar;
        String s9 =lib;
        String s10=mag;
        String s11=classroom;
        String s12=lab;                                         
        String s13=infra;      
        String s14=services;
        String s15=placement;
        ...
        try {
            if (s1.length() == 0 || s2.length() == 0) {
                ...
                Institute_evaluationimpl obj = new Institute_evaluationimpl();
                obj.insertInstitute_evaluation(s1, s2, s2, s2, s2, s2, s2, s2, s2, s1, s1, s2, s1, s1, s1);
            }
        } catch (Exception ex) {
